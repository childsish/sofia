...
MafLine = namedtuple('MafLine', ('hugo_symbol', 'entrez_gene_id', 'center', 'build', 'chromosome', 'start_position',
                                 'end_position', 'strand', 'variant_classification', 'reference_allele',
                                 ...
                                 'tumour_sample_uuid', 'matched_norm_sample_uuid'))
